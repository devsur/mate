...
const AuthModal = ({ setShowModal }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        try {
            if (isSignUp && (password !== confirmPassword)) setError("Passwords need to match!");
    ...
    return (
        <div className="auth-modal">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="password" id="password-check" name="password-check" placeholder="confirm password" required={true} onChange={e => setConfirmPassword(e.target.value)} />
